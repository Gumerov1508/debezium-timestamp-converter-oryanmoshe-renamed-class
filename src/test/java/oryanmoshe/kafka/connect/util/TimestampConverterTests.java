...
public class TimestampConverterTests {
    ...
    @ParameterizedTest
    @CsvSource({ "YY-MM-dd, YY-MM-dd", "," + CustomTimestampConverter.DEFAULT_DATE_FORMAT })
    void configureDateTest(final String inputFormat, final String expectedFormat) {
        final CustomTimestampConverter tsConverter = new CustomTimestampConverter();
    ...
    @ParameterizedTest
    @CsvSource({ "mm:ss.SSS, mm:ss.SSS", "," + CustomTimestampConverter.DEFAULT_TIME_FORMAT })
